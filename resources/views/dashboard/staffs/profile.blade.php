                ...
                <div class="m-auto my-4">
                    <form action="saveInformation" method="post" class="space-y-4 border-1 rounded shadow-2xl py-10 px-20">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <input  name="branchID" type="text"required autocomplete="off" class="border-1 rounded shadow px-3" value="{{ Auth::user()->branch_id }}" readonly></input>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div></div>
                            <button type="submit" class="bg-green-500 rounded-2xl w-40 py-1 text-white px-3">Хадгалах</button>
                        </div>
